...
LR_PATH = '/workspace/rahnemacollege/Project/Git/demand-prediction/data/output/lr_result.parquet'
XGB_PATH = '/workspace/rahnemacollege/Project/Git/demand-prediction/data/output/XGB_result.parquet'

PRED_RESULT_PATH = f"/workspace/rahnemacollege/Project/Git/demand-prediction/data/Pred_Result_{int(time.time())}.csv"
